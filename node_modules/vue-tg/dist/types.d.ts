...
export type OnEventWithOptions<O> = {
    (eventType: "themeChanged" | "mainButtonClicked" | "backButtonClicked" | "settingsButtonClicked" | "biometricManagerUpdated", eventHandler: () => void, options?: O): OnEventReturn;
    (eventType: "popupClosed", eventHandler: (eventData: {
        button_id: string | null;
    }) => void, options?: O): OnEventReturn;
    ...
    (eventType: "contactRequested", eventHandler: (eventData: RequestContactResponse) => void, options?: O): OnEventReturn;
    (eventType: "biometricAuthRequested", eventHandler: (eventData: {
        isAuthenticated: boolean;
        biometricToken?: string;
    }) => void, options?: O): OnEventReturn;
    (eventType: "biometricTokenUpdated", eventHandler: (eventData: {
        isUpdated: boolean;
    }) => void, options?: O): OnEventReturn;
};
/**
